from domain.furnitures.msp import Msp
from domain.value_objects.dimensions import Dimensions
from domain.value_objects.prices import Prices
from ..schemas.furnitures.bitrix_msp_schema import BitrixMspSchema
from ..schemas.calculations.bitrix_calculation_msp_schema import BitrixCalculationMspSchema
...
class ArmchairMapper:
    ...
    def map_bitrix_to_domain(
            self,
            data: BitrixMspSchema,
            economy_data: BitrixEconomySchema,
            fot_data: BitrixFotSchema,
            calculation_data: BitrixCalculationMspSchema
        ) -> Msp:
    ...
    def _calc_fabric_consumption(self, calculation_data: BitrixCalculationMspSchema) -> float:
    ...
    def _get_dimensions(self, data: BitrixMspSchema) -> Dimensions:
        return Dimensions(
            width=data.width,
            height=data.height,
            depth=data.depth
    ...
    def _get_prices(self, economy_data: BitrixEconomySchema, fot_data: BitrixFotSchema, calculation_data: BitrixCalculationMspSchema) -> Prices:
        return Prices(
