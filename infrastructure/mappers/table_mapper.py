from domain.furnitures.table import Table
from domain.value_objects.dimensions import Dimensions
from domain.value_objects.prices import Prices
from ..schemas.furnitures.bitrix_table_schema import BitrixTableSchema
from ..schemas.calculations.bitrix_calculation_table_schema import BitrixCalculationTableSchema
...
class TableMapper:
    ...
    def map_bitrix_to_domain(
            self,
            data: BitrixTableSchema,
            economy_data: BitrixEconomySchema,
            fot_data: BitrixFotSchema,
            calculation_data: BitrixCalculationTableSchema
        ) -> Table:
    ...
    def _calc_fabric_consumption(self, calculation_data: BitrixCalculationTableSchema) -> float:
    ...
    def _get_dimensions(self, data: BitrixTableSchema) -> Dimensions:
        return Dimensions(
            width=data.width,
            height=data.height,
            depth=data.depth
    ...
    def _get_prices(self, economy_data: BitrixEconomySchema, fot_data: BitrixFotSchema, calculation_data: BitrixCalculationTableSchema) -> Prices:
        return Prices(
